...
const SidebarSplantExchangerPkg = () => {
            ...
            <div className="flex items-center ml-5 mt-[-118px]">
                ...
                <div className="flex items-center ml-[-66px] text-[20px] mt-12">
                    ...
                    <div className="flex items-center ml-[-86px] text-[20px] mt-12">
                        ...
                        <div className="flex items-center ml-[-86px] text-[20px] mt-12">
                            <IoIosPlay className="mb-[-4px] mt-[135px] ml-[-25px]"/>
                            <span className="mt-[164px] ml-2">S-Plant-SAT-Com-Compression</span>
                            <div className="flex items-center ml-[-86px] text-[20px] mt-12">
                                <IoIosPlay className="mb-[-4px] mt-[175px] ml-[-45px]"/>
                                <span className="mt-[200px] ml-2">S-Plant-Ex-201-Excahnger-Package</span>
                            </div>
                        </div>
                    </div>
                </div>
...
export default SidebarSplantExchangerPkg;
